...
<body class="clean-body" style="margin: 0; padding: 0; -webkit-text-size-adjust: 100%; background-color: #F1F3F3;">
    ...
    <p style="font-size: 50px; line-height: 1.2; mso-line-height-alt: 60px; margin: 0;"><span style="font-size: 50px;">
        ...
        @else
            <span style="font-size: 30px;"> 
                <span class="">Welcome to PinoyTravel Reseller</span>
        @endif
    ...
    <div style="color:#66BECD;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;line-height:1.2;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
    <div style="font-size: 12px; line-height: 1.2; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #66BECD; mso-line-height-alt: 14px;">
    <p style="font-size: 24px; line-height: 1.2; text-align: left; mso-line-height-alt: 29px; margin: 0;"><span style="font-size: 24px;">
    ...
    <div style="font-size:1px;line-height:10px"> </div><img align="center" alt="Image" border="0" class="center autowidth fullwidth" src="{{asset('img/icon/divider.png')}}" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 634px; display: block;" title="Image" width="634"/>
    <!--[if mso]></td></tr></table><![endif]-->
    </div>
    <!--[if (!mso)&(!IE)]><!-->
    </div>
    ...
    <p style="font-size: 17px; line-height: 1.5; text-align: left; mso-line-height-alt: 26px; mso-ansi-font-size: 18px; margin: 0;"><span style="font-size: 17px; mso-ansi-font-size: 18px;">
        ...
        @if($data['type'] == "Deleted")
        This account is currently <b>DELETED</b> to our records. This means you cannot login your account anymore unless the admin decided to reactivate this account. If you wish to recover your account 
        @elseif($data['type'] == "On Hold")
        This account is currently <b>ON-HOLD</b> to our records. This means you cannot perform any transactions of PinoyTravel Reseller. Viewing records is the only service you can perform. If you wish to recover your account 
        @elseif($data['type'] == "Active")
        This account is currently <b>ACTIVE</b> to our records. This means you can perform any transaction within the PinoyTravel Reseller. If you have any concerns 
        @elseif($data['type'] == "New")
        This account is new registered account to our site. You may proceed to <a href="{{ env('APP_URL') }}">{{ env('APP_URL') }}</a> to use our services such as: <em>Top Up, Pay Bookings, and view your records.</em> If you have any concerns 
        @else
        Nothing to our records. 
        @endif
        
        please contact our support.
        <br>
        <br>
        <b>Reseller Email: </b> {{ $data['email'] }}
        <br>
    ...
    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img align="center" alt="Image" border="0" class="center fixedwidth" src="{{asset('img/icon//pt_logo.png')}}" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 158px; display: block;" title="Image" width="158"/>
    <!--[if mso]></td></tr></table><![endif]-->
    </div>
    ...
    <p style="font-size: 14px; line-height: 1.2; text-align: center; mso-line-height-alt: 17px; margin: 0;"><strong>CONTACT US</strong></p>
    </div>
    </div>
    <!--[if mso]></td></tr></table><![endif]-->
    ...
    <td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 5px;" valign="top"><a href="https://www.facebook.com/PinoyTravel/" target="_blank"><img alt="Facebook" height="32" src="{{asset('img/icon/facebook@2x.png')}}" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;" title="Facebook" width="32"/></a></td>
    <!-- <td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 5px;" valign="top"><a href="https://www.pinoytravel.com.ph/" target="_blank"><img alt="PinoyTravel" height="32" src="images/twitter@2x.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;" title="Twitter" width="32"/></a></td> -->
    <td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 5px;" valign="top"><a href="https://instagram.com/" target="_blank"><img alt="Instagram" height="32" src="{{asset('img/icon/instagram@2x.png')}}" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;" title="Instagram" width="32"/></a></td>
    ...
    <p style="font-size: 14px; line-height: 1.2; text-align: left; mso-line-height-alt: 17px; margin: 0;">Pinoy Travel Reseller / <strong><a href="https://www.pinoytravel.com.ph/contact" rel="noopener" style="text-decoration: underline; color: #66BECD;" target="_blank">support@pinoytravel.com.ph</a></strong></p>
    </div>
    </div>
    <!--[if mso]></td></tr></table><![endif]-->
    <!--[if (!mso)&(!IE)]><!-->
